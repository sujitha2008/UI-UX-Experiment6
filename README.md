...
To apply various UX design techniques such as solution ideation, user story creation, scenario creation, flow mapping, and information architecture to understand user needs and develop a simple and user-friendly design.

## Algorithm:

1. Identify a suitable UX problem and generate multiple solution ideas using Crazy 8s or brainwriting.

2. Create user personas and write at least five user stories based on their goals.

3. Select a user story and create a narrative scenario including the user's context, environment, tasks, and emotional state.

4. Select a task and create a task flow/user flow diagram using standard symbols such as start, action, decision, and end.

5. Perform card sorting to organize related information into suitable categories.

6. Create an Information Architecture (IA) site map based on the categorized information.

7. Review all the designs to ensure that they are clear, logical, and user-friendly.
...
Eight low-fidelity ideas generated in the Crazy 8s exercise (1 idea per minute):
...
● Priya (28) – New mother, needs quick pediatrician access for her infant.

● Ravi (45) – Caregiver, manages healthcare bookings for his elderly parents.

● Divya (21) – College student, first-time user of the hospital app.


User Stories:

● As an elderly patient, I want to book an appointment using voice commands, so that I don't need to type or navigate complex menus.

● As a working professional, I want to view available slots for evenings and weekends, so that I can book without missing office hours.

● As a new mother, I want to quickly find and book a pediatrician near me, so that my child gets timely care.

● As a caregiver, I want to book and manage appointments on behalf of my parents from my own account, so that I can coordinate their healthcare remotely.
...
Symbols used: Oval = Start/End, Rectangle = Action/Process, Diamond = Decision point, Arrow = Flow direction.
...
<img width="960" height="418" alt="ia_table" src="https://github.com/user-attachments/assets/59409462-818d-424f-b97b-9eb5237e543c" />


Site Map (categorized structure):


<img width="2667" height="256" alt="sitemap" src="https://github.com/user-attachments/assets/d82cfb3c-d445-4136-bd0f-a7385d00d9a6" />


## Result:

Thus, the five UX design activities — solution ideation, user story creation, scenario creation, flow mapping, and information architecture — were successfully performed. The activities helped in understanding user needs and developing a clear, organized, and user-friendly design.
